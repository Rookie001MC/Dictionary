...
void setStyles()
{
    ...
    GuiSetStyle(TEXTBOX, TEXT_COLOR_PRESSED, TEXT_COLOR);
    GuiSetStyle(TEXTBOX, BORDER_COLOR_PRESSED, TEXT_COLOR);
    GuiSetStyle(TEXTBOX, BORDER_COLOR_FOCUSED, TEXT_COLOR);
