...
#define PRIMARY_COLOR_CONTAINER_RGB                                                                                    \
    (Color)                                                                                                            \
    {                                                                                                                  \
        241, 194, 123, 255                                                                                             \
    }
...
#define PRIMARY_COLOR_CONTAINER_HOVER_RGB                                                                              \
    (Color)                                                                                                            \
    {                                                                                                                  \
        250, 234, 212, 255                                                                                             \
    }
...
#define SECONDARY_COLOR_RGB                                                                                            \
    (Color)                                                                                                            \
    {                                                                                                                  \
        181, 201, 154, 255                                                                                             \
    }

#define BOX_COLOR_RGB                                                                                                  \
    (Color)                                                                                                            \
    {                                                                                                                  \
        196, 193, 164, 255                                                                                             \
    }
...
#define SECONDARY_COLOR_CONTAINER_RGB                                                                                  \
    (Color)                                                                                                            \
    {                                                                                                                  \
        0xff, 0xdd, 0xb6, 0xff                                                                                         \
    }
...
#define QUESTION_HOVER_RED (0xC70039FF)
#define QUESTION_HOVER_BLUE (0x008390FF)
#define QUESTION_COLOR_BLUE (0x009DABFF)
#define QUESTION_COLOR_YELLOW (0xffb82cFF)
#define QUESTION_HOVER_YELLOW (0xf8a500FF)
#define QUESTION_HOVER_GREEN (0x557A46FF)
#define QUESTION_COLOR_GREEN (0x7A9D54FF)
